...
Change the config.ini file to set the provider_name to a supported provider and provider_model to a LLM supported by your provider. We recommnd reasoning model such as *Qwen* or *Deepseek*.
